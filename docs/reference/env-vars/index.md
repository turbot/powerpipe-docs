...
| [STEAMPIPE_QUERY_TIMEOUT](reference/env-vars/powerpipe_query_timeout)  |  `240` | Set the amount of time to wait for a query to complete before timing out, in seconds.
